...
# Error message is printed of the tolerances are not obtained.
...
def newton(F,DF,x0,tolf,tolx,kmax):
    ...
    for k in range(1,kmax):                               # Loop over Newton iterations.
        ...
        print('it=%d x=%e err=%e res=%e step=%e' % (k,x,err,res,dx)) # Print error and residual for diagnostic purposes.
